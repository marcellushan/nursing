 <div class="main container">
	<h1 class= "mytitle">Verify Image	</h1>
	 ...
	 <form action="<? echo base_url() ?>admin/put/<?=$applicant->applicant_id ?>" method="post" >
		 <input type="hidden" name="identification_verified" value="1">
		 <input type="hidden" name="identification_verified_date" value="<?=date('Y-m-d') ?>">
		 <input type="hidden" name="identification_verified_by" value="<?=$admin ?>">
