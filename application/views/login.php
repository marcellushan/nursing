	...
	<div class="row">
		...
		<h1 class="wrapper">Returning Applicant Login</h1>
			...
			<form action="<?=base_url("home/checkLogin")?>" method="post" id="login">
				<fieldset>
					<div class="row">
						<label class="col-md-2 col-md-offset-4 col-xs-6">Email </label><input type="text" class="col-md-3 col-xs-5" name="email">
						<label class="col-md-2 col-md-offset-4 col-xs-6">Password</label> <input type="password" class="col-md-3 col-xs-5" name="password">
					</div>
					<div class="row">
